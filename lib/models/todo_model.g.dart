...
Todo _todoDeserialize(
  ...
  object.id = id;
  object.status = _TodostatusValueEnumMap[reader.readByteOrNull(offsets[1])] ??
      TodoStatus.todo;
  return object;
}
...
extension TodoQueryWhere on QueryBuilder<Todo, Todo, QWhereClause> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
